...
import com.example.disaster.dialogs.ProgressDialogFragment;
import com.example.disaster.location.DirectionsDialogFragment;
import com.example.disaster.location.RoutingDialogFragment;
import com.example.disaster.tools.Compass;
import com.example.disaster.util.TaskExecutor;
		...
		RoutingDialogFragment.RoutingDialogListener, OnCancelListener
{
	...
	//todo	navButton = (ImageButton) mSearchBox.findViewById(R.id.btn_nav_menu);
		...
		//todo mSearchview = (SearchView) mSearchBox.findViewById(R.id.searchView1);

		//todo ImageView iv_route = (ImageView) mSearchBox.findViewById(R.id.imageView1);
	 ...
	 */
/*todo	private void applySuggestionCursor() {
...
/*	private void showRoutingResultLayout(double distance, double time) {
  ...
  @Override public void onBasemapChanged(String itemId) {
	  HomeActivity homeActivity = new HomeActivity();
		homeActivity.showMap(mPortalItemId,
       itemId);
  }
